...
console.log('PASS: validation, CSRF, 3 distinct quotes/works, replay consistency, cross-owner read/reveal/feedback/delete denial, feedback persistence, idempotence, deletion.');
